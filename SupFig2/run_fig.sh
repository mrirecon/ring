...
python3 ../../Python_Plotting/figcreator.py -t"LTh:a)" _res_RECsp${REC[1]}.png _resa.png
python3 ../../Python_Plotting/figcreator.py -t"LTh:b)" _res_RECsp${REC[2]}.png _resb.png
